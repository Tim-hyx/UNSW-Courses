...
for cast in range(nb_of_casts):
    for possible_outcome in range(max(dice)):
        ...
        for die in dice:
            if possible_outcome < die:
                outcomes_probabilities[possible_outcome] += hypotheses_probabilities[die] / die
    ...
    for die in dice:
        if number_cast >= die:
            ...
            hypotheses_probabilities[die] = hypotheses_probabilities[die] / (die * outcomes_probabilities[number_cast])
