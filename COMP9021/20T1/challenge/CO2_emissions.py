...
datafile = 'API_EN/API_EN.ATM.CO2E.KT_DS2_en_csv_v2_422491.csv'
emissions = {}
no_data = {}
try:
    with open(datafile) as csvfile:
        ...
        for line in file:
            ...
            if code:
                ...
                print('Leaving out', country)
except FileNotFoundError:
    print(f'Could not open {datafile}, giving up.')
    sys.exit()
emissions_map = World(style=Style(colors=('#B22222', '#A9A9A9'),
                                  tooltip_font_size=8, legend_font_size=10
                                 )
                     )
emissions_map.title = 'CO2 emissions in 2014'
