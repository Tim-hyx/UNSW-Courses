...
console.log('Sum = ' + sum_numbers(numbers))
console.log('Positive Sum = ' + sum_positive(numbers))
console.log('Even Sum = ' + sum_even(numbers))
console.log('Sum of numbers above 400 = ' + sum_400(numbers))
console.log('Sum of numbers between indexes 20 and 40 inclusively = ' + sum_20to40(numbers))